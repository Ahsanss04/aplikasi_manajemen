...
class LaporanBarangKeluarPage extends StatefulWidget {
  @override
  _LaporanBarangKeluarPageState createState() => _LaporanBarangKeluarPageState();
}
...
class _LaporanBarangKeluarPageState extends State<LaporanBarangKeluarPage> {
  ...
  Future<void> _ambilLaporan() async {
    ...
    final response = await http.post(
      Uri.parse('http://localhost/api/get_laporan_barang_keluar.php'),
      body: {
  ...
  Future<void> _ambilSemuaData() async {
    final response = await http.get(
      Uri.parse('http://localhost/api/get_data_barang_keluar.php'),
    );
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 30),
            Text('Data Semua Barang Keluar:', style: TextStyle(fontWeight: FontWeight.bold)),
